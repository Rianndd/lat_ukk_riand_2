                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-6 text-end">
                            <a href="{{ route('users.create') }}" class="btn btn-primary"><i class="bx bx-plus"></i>
                                Tambah Data</a>
                        </div>
                    </div>
                </div>
                        ...
                        <tbody>
                            @foreach ($user as $key => $row)
                                <tr>
                                    ...
                                    <td class="text-start">
                                        {{ $row->level == 1 ? 'Admin' : ($row->level == 2 ? 'Kasir' : '') }}</td>
                                    <td align="center">
...
<script>
    function confirmDelete() {
        return confirm('Apakah yakin akan menghapus user ini ?');
    }
</script>
