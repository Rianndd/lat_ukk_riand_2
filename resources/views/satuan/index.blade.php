                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-6 text-end">
                            <a href="{{ route('satuan.create') }}" class="btn btn-primary"><i class="bx bx-plus"></i>
                                Tambah Data</a>
                        </div>
                    </div>
                </div>
                                ...
                                <tr align="center">
                                    ...
                                    <td align="center">
                                        <div class="d-flex justify-content-center">
                                            <a href="{{ route('satuan.edit', $row->id) }}"
...
<script>
    function confirmDelete() {
        return confirm('Apakah yakin akan menghapus satuan ini ?');
    }
</script>
