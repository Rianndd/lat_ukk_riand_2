<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="/" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bolder ms-2">E - Kasir</span>
        </a>
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item {{ Request::is('pembelian*') ? 'active' : '' }}">
            <a href="{{ route('pembelian.index') }}" class="menu-link">
                ...
                <div data-i18n="Analytics">Pembelian Stok</div>
            </a>
        </li>
        <!-- Transaksi -->
        ...
        <li class="menu-item {{ Request::is('users*') ? 'active' : '' }}">
            <a href="{{ route('users.index') }}" class="menu-link">
                ...
                <div data-i18n="Analytics">Setting User</div>
            </a>
        </li>
    </ul>
</aside>
